...
public class Constants {
	...
	public static final int TOKEN = 27; // 3
	public static final int TOKEN_TYPE_HINT = 28; //3 
	public static final int ACTIVE = 29; // boolean
	public static final int CLIENT_TOKEN = 30; //5
	public static final int RS_CNF = 31; //5
