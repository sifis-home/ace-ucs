 ...
 *
 * Procedure:
 * 1) Run the DtlsProtocolASTestServer.java
 * 2) Run the DtlsProtocolRSTestServer.java
...
public class DtlsProtocolCTestClient {
    ...
    public DtlsProtocolCTestClient(String id, byte[] key128, Integer port){

        DtlsProtocolCTestClient.clientId = id;

        if (key128 != null)
            DtlsProtocolCTestClient.key128 = key128;

        if (port != null)
            DtlsProtocolCTestClient.RS_COAP_SECURE_PORT = port;
    }
