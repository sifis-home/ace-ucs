...
public class OscoreRsServer {
    ...
    static GroupOSCOREJoinValidator valid;
    
    static Map<String, Map<String, Set<Short>>> myScopes;
...
//        ai.processMessage(new LocalMessage(0, null, null, payload));
     ...
     */
    public static class GroupOSCOREJoinResourceOLD extends CoapResource {
    	
		/**
         * Constructor
         * @param resId  the resource identifier
         */
        public GroupOSCOREJoinResourceOLD(String resId) {
    ...
    public static class GroupOSCORESubResourceNodename extends CoapResource {
        ...
        public void handleGET(CoapExchange exchange) {
        	...
        	if (targetedGroup.getGroupMemberRoles((targetedGroup.getGroupMemberName(subject))) !=
        		...
        		senderId = hexStringToByteArray(myString.substring(myString.indexOf(nodeNameSeparator) + 1));
        	}
