...
public class OSCoreCtx {
	...
	protected AlgorithmID common_alg;
	protected byte[] common_master_secret;
	protected byte[] common_master_salt;
	...
	protected byte[] deriveKey(byte[] secret, byte[] salt, int cbitKey, String digest, byte[] rgbContext)
