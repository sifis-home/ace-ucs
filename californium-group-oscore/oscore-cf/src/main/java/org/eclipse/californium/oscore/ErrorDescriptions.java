...
public final class ErrorDescriptions {
	...
	public static final String UNEXPECTED_OBSERVE = ("An unexpected observe option");
	public static final String SOURCE_ADRESS_NULL = ("Source adress is null");
	...
	public static final String COUNTERSIGNATURE_CHECK_FAILED = "Failure during Countersignature check";
